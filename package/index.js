...
// mongoose.connect(process.env.localhost:27017/DemoOne,
mongoose.connect("mongodb://localhost:27017/CsvAssign/DemoOne",
{ useNewUrlParser: true, useUnifiedTopology: true }, err => {
    console.log('Connected to database!')
});
app.listen('3000' || process.env.//localhost:3000/, err => {
    if (err)
        throw err
